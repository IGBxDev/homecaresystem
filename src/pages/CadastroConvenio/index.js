...
// ---------------------------------------------------------------------------------------
  ...
  const header = (
    <div className="table-header">
        <h5 className="mx-0 my-1">Pesquisar convênio</h5>
  ...
  const popUpCadastroProfissional = (
    <Dialog visible={newProductsDialog} style={{ width: "800px" }} header="Novo registro" modal className="card p-fluid" footer={productDialogFooter} onHide={hideDialog} >
      
      <label htmlFor="name">Dados do convênio</label>
      <div className="field">        
        <TextField className='info-profissional' name='nomeCompletto' value={dataForm.nomeCompletto} onChange={(e)=> handleInputChange(e)} label="Convênio" margin="normal"variant="outlined" />
        <TextField className='info-profissional' name='emailConvenio' value={dataForm.emailConvenio} onChange={(e)=> handleInputChange(e)} label="E-mail do convênio" margin="normal"variant="outlined" />
        <TextField className='info-profissional' name='telefoneConvenio' value={dataForm.telefoneConvenio} onChange={(e)=> handleInputChange(e)} label="Telefone do convênio" margin="normal" variant="outlined" />
        <TextField className='info-profissional' name='gerente' value={dataForm.gerente} onChange={(e)=> handleInputChange(e)} label="Gerente" margin="normal" variant="outlined" />
        <TextField className='info-profissional' name='emailGerente' value={dataForm.emailGerente} onChange={(e)=> handleInputChange(e)} label="Email do Gerente" margin="normal" variant="outlined" />
        <TextField className='info-profissional' name='telefoneGerente' value={dataForm.telefoneGerente} onChange={(e)=> handleInputChange(e)} label="Telefone do Gerente" margin="normal" variant="outlined" />
      </div>
      ...
      <div className="field">        
        ...
        <TextField className='info-profissional' name='complemento' value={dataForm.complemento} onChange={(e)=> handleInputChange(e)} vlabel="Complemento" margin="normal" variant="outlined" />
  ...
  return (
    <div className="App">
      ...
      <div className={`content${isHumburguerActive? '-active' : '' }`}>
        <Title nome="Convênio cadastrados">
        ...
        <div className="container-dash">
          ...
          <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
              ...
              <Column field="convenio" header="Convênio" sortable style={{ minWidth: '12rem' }}></Column>
              <Column field="emailConvenio" header="E-mail do convênio" sortable style={{ minWidth: '12rem' }}></Column>
              <Column field="telefoneConvenio" header="Telefone do convênio" sortable style={{ minWidth: '12rem' }}></Column>
              <Column field="gerente" header="Gerente" sortable style={{ minWidth: '12rem' }}></Column>
              <Column field="emailGerente" header="E-mail do Gerente" sortable style={{ minWidth: '12rem' }}></Column>
              <Column field="telefoneGerente" header="Telefone do Gerente" sortable style={{ minWidth: '12rem' }}></Column>
